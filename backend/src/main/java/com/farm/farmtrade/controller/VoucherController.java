    ...
    public class VoucherController {
        ...
        public ResponseEntity<Map<String, Object>> redeemVoucher(@RequestBody RedeemVoucherRequest request) {
            Map<String, Object> response = userVoucherService.redeemVoucher(request.getUserId(), request.getVoucherId());
