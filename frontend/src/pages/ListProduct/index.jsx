...
const ListProduct = () => {
    ...
    const handleUnhide = async (product) => {
        try {
            await updateProductStatus(product.productID, "In Stock");
                            ...
                            <div className="table-responsive">
                                <table className="table align-middle">
                                    ...
                                    {products.map((product) => (<tr key={product.productID}>
                                            ...
                                            <td>
                          <span
                              className={`status-badge ${product.status === "In Stock" ? "status-success" : product.status === "Hidden" ? "status-warning" : product.status === "Pending" ? "status-info" : "status-danger"}`}
                          >
                                {product.status}
                            </span>
                                            </td>
