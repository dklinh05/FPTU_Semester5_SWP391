        ...
        <div className="container mt-4">
            ...
            <table className="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    {products.length === 0 ? (
                        <tr>
                            <td colSpan="9" className="text-center">Không có sản phẩm nào đang chờ duyệt</td>
                        </tr>
                    ) : (
                        products.map((product) => (
                            <tr key={product.productID}>
                                ...
                                <td>
                                    {product.imageURL ? (
                                        <img src={product.imageURL} alt="Sản phẩm" style={{ width: "100px", height: "auto" }} />
                                    ) : (
                                        "Chưa có ảnh"
                                    )}
                                </td>
                                ...
                                <td><span className="badge bg-warning text-dark">{product.status}</span></td>
                                <td>
                                    <button
